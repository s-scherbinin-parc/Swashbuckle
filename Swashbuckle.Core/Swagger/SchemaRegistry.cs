...
namespace Swashbuckle.Swagger
{
	public class SchemaRegistry
	{
		...
		private Schema CreateInlineSchema(Type type)
		{
			...
			var dynamicContract = jsonContract as JsonDynamicContract;
		...
		private Schema CreateDefinitionSchema(Type type)
		{
			...
			if (jsonContract is JsonDynamicContract)
				return CreateObjectSchema((JsonDynamicContract)jsonContract);
		...
		private Schema CreateObjectSchema(JsonDynamicContract jsonContract)
		{
